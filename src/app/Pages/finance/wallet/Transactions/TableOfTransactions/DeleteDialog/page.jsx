  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center px-8 pt-9 pb-6">
        ...
        <h2 className="text-[#364152] text-lg font-bold mb-2 max-w-[340px]">{t('Are you sure you want to delete the transaction?')}</h2>
        <p className="text-[#697586] text-sm font-normal leading-relaxed max-w-[360px]">{t('This transaction will be permanently deleted and cannot be recovered later.')}</p>
      </div>
