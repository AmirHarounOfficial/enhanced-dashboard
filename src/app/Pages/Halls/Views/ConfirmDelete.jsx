  ...
  return (
    <>
      <Dialog
        ...
        >
          <button onClick={() => setDeleteId(false)} className="modal-close" aria-label={t('cancel')}>
          ...
          <div className="modal-footer">
            <button onClick={() => setDeleteId(false)} className="btn-ghost flex-1">{t('cancel')}</button>
            <button onClick={() => { handleDelete(deleteId); setDeleteId(null); }} className="btn-danger flex-1">{t('delete')}</button>
          </div>
        </Dialog>
