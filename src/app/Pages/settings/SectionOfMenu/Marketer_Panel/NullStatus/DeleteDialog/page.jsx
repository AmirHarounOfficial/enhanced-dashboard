...
function DeleteDialogPage({open,setOpen , handleDeleteImage}) {
    ...
    >
      ...
      <div className='flex flex-col  items-center mb-6'>
        <p className='text-[#0F022E] text-xl font-semibold mb-4'>
          {t('Are you sure you deleted the image?')}
        </p>
        <p className='text-[#697586] text-base font-normal w-97 text-center '>
          { t('This image will be removed and will no longer be available.')}
        </p>
      </div>
      ...
      <section className='w-full flex p-6 gap-3'>
        <button 
          ...
          className='w-full  bg-[#D92D20] text-[#fff]  h-11  rounded-[6px] cursor-pointer '
        >
        ...
        <button 
          ...
          className='w-full border border-[#697586] text-[#4B5565]  h-11  rounded-[6px]  cursor-pointer'
        >
