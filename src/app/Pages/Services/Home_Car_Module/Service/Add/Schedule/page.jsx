  ...
  return (
    <>
        ...
        <div className="grid grid-cols-7 gap-5 w-full ">
          {days.map((day) => (
            <button
              ...
              className={`w-full h-11 border rounded-[10px] shadow-xs transition-all text-base font-medium ${
                selectedDays.includes(day.id)
                  ? "border-[#C69815] bg-[#FEF0C7] text-[#C69815]"
      ...
      <div className="flex justify-end mt-6">
        <button
          onClick={addPeriod}
          className="flex items-center justify-center border border-[#C69815] hover:bg-[#FFFDF8] transition-all rounded-[10px] w-[197px] h-11 cursor-pointer"
        >
