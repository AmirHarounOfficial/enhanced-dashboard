    ...
    <>
      ...
      >
        ...
        <section className="  px-6 mt-6">
          ...
          <p className='text-[#364152] text-lg font-bold flex justify-center mb-4'>{t('Add pricing')}</p>
        </section>
        ...
        <div className="modal-footer">
          <button onClick={handleSubmit} className="btn-primary flex-1 h-11 rounded-[10px] text-white text-sm font-semibold">{t("It was completed")}</button>
