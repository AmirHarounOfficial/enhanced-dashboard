      ...
      <div className=' p-6'>
        ...
        <div className='border border-[#E3E8EF] p-6'>
          ...
          <div className='border border-[#E3E8EF] p-6'>
            ...
            {/*  */}
            <div className='border border-[#E3E8EF] p-3 mb-4'>
              ...
              {openContent && (
                <div className="py-4 ">
                  {fuel?.map((fuel) => (
                    <div 
                      key={fuel?.id} 
                      className='flex justify-between py-3 px-2 mb-3 border border-[#E3E8EF]  ' 
                  ...
                  <button
                    ...
                    className='flex gap-2 justify-center items-center w-full h-11 border border-[#C69815] text-[#C69815] hover:bg-[#FFFDF8] transition-all rounded-[10px] cursor-pointer'>
          ...
          <button 
            onClick={handleSave}
            className='btn-primary h-11 px-6 w-[25%] rounded-[10px] text-white text-sm font-semibold my-6 cursor-pointer'>
            {t('It was completed')}
          </button>
