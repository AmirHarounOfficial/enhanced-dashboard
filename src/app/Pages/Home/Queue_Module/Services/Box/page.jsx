...
function BoxPage({ getcounters }) {
  ...
  const cards = [
    {
      icon: '/images/icons/invoice-red.svg',
      bg: '#FEF3F2',
      iconShadow: 'shadow-[0_2px_6px_rgb(240_68_56_/_0.15)]',
      tagClass: 'text-[#F04438] bg-[#FEF3F2] border border-[#FEE4E2]',
      dotColor: 'bg-[#F04438]',
      tag: t('Today'),
      label: t('Today bookings'),
      value: getcounters?.today_reservations_count,
    },
    {
      icon: '/images/icons/invoice-green.svg',
      bg: '#DCFAE6',
      ...
      value: getcounters?.active_tables_count,
    },
    {
      icon: '/images/icons/loading-yellow.svg',
      bg: '#FEF0C7',
      ...
      value: getcounters?.waitlist_count,
    },
    {
      icon: '/images/icons/tick-blue.svg',
      bg: '#FEF0C7',
      iconShadow: 'shadow-[0_2px_6px_rgb(198_152_21_/_0.18)]',
      tagClass: 'text-[#C69815] bg-[#FEF0C7] border border-[#F5D469]',
      dotColor: 'bg-[#C69815]',
      tag: t('Done'),
      label: t('Complete'),
      value: getcounters?.completed_count,
    },
  ];
