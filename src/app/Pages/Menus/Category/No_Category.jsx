...
function No_Category({setOpenAdd}) {
  ...
  return (
    <>
        ...
        <button
          ...
          className='flex justify-center gap-2 bg-[var(--color-primary)] text-white px-4 py-2.5 h-14 w-[25%] rounded-[6px] my-6 cursor-pointer'
        >
